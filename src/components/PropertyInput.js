          ...
          <Form onSubmit={this.handleSubmit}>
            ...
            <Form.Group>
              <Form.File
                ...
                name="file"
                label="Upload images"
                onChange={this.updateImageFormData}
              />
            </Form.Group>
            ...
            <Form.Group>
              ...
              <Form.Control
                as="select"
                name="bedroomNumber"
                value={this.state.bedroomNumber.value}
                onChange={this.handleChange}
              >
            ...
            <Form.Group>
              ...
              <Form.Control
                as="select"
                name="bathroomNumber"
                value={this.state.bathroomNumber.value}
                onChange={this.handleChange}
              >
...
export default withRouter(
  connect((state) => ({ user: state.user }), { createProperty })(PropertyInput)
);
