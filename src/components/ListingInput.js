        ...
        <div style={{ width: "60%", paddingLeft: "100px" }}>
          <Form onSubmit={this.handleSubmit}>
            ...
            <Form.Group>
              ...
              <Form.Control
                type="date"
                name="avail_date_begin"
                value={this.state.avail_date_begin}
                onChange={this.handleChange}
              />
            </Form.Group>
            ...
            <Form.Group>
              ...
              <Form.Control
                type="date"
                name="avail_date_end"
                value={this.state.avail_date_end}
                onChange={this.handleChange}
              />
            </Form.Group>
            ...
            <Form.Group>
              ...
              <Form.Text Muted>
                People can rent your place if you choose Yes
              </Form.Text>
              <Form.Control
                as="select"
                name="rent_mode"
                value={this.state.rent_mode}
                onChange={this.handleChange}
              >
            ...
            <Form.Group>
              ...
              <Form.Text Muted>
                People can exchange with your place if you choose Yes
              </Form.Text>
              <Form.Control
                as="select"
                name="trade_mode"
                value={this.state.trade_mode}
                onChange={this.handleChange}
              >
                <option value="true">Yes</option>
                <option value="false">No</option>
            ...
            <Form.Group>
              ...
              <Form.Text Muted>
                Are you strict with price, timeframe, or trade mode
              </Form.Text>
              <Form.Control
                as="select"
                name="strict_mode"
                value={this.state.strict_mode}
                onChange={this.handleChange}
              >
                <option value="true">Yes</option>
                <option value="false">No</option>
